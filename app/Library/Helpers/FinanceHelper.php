...
//Models
use App\Models\Finances\WalletJournal;
...
class FinanceHelper {
        ...
        do {
            ...
            if($pageFailed == false) {
                ...
                foreach($wallet as $entry) {                 
                    ...
                    $found = WalletJournal::where([
                        'id' => $entry['id'],
                    ])->count();

                    if($found == 0) {
                        $awj = new WalletJournal;
                        $awj->id = $entry['id'];
    ...
    /**
     * Get the pages for the wallet journal
     */
    public function GetWalletJournalPages($division, $charId) {
        $lookup = new LookupHelper;
        $esiHelper = new Esi;
