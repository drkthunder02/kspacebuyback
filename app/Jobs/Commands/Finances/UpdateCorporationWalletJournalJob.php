...
class UpdateCorporationWalletJournalJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $pages = $fHelper->GetWalletJournalPages(1, $config['primary']);
        ...
        for($i = 1; $i <= $pages; $i++) {
            UpdateCorporationWalletJournalPage::dispatch(1, $config['primary'], $i)->onQueue('journal');
        }
    }
    ...
    public function tags() {
        return ['UpdateCorporationWalletJournal', 'Finances'];
    }
}
